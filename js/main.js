...
const SERVICE_DATA = {
  ...
  electric: {
    ...
    prices: [
      ...
      ['Подключение варочной панели', '1 500 – 2 500 ₽'],
      ...
      ['Диагностика электропроводки', '1 000 – 2 000 ₽'],
    ]
  },
  mounting: {
    icon: '🖼️',
  ...
  doors: {
    icon: '🚪',
    title: 'Двери и замки',
    subtitle: 'Установка, ремонт дверей, замена замков и фурнитуры',
    prices: [
      ['Установка межкомнатной двери', '2 500 – 4 500 ₽'],
      ['Установка дверной коробки', '2 000 – 3 500 ₽'],
      ['Замена дверного замка', '800 – 2 000 ₽'],
      ['Врезка замка в новую дверь', '1 200 – 2 500 ₽'],
      ['Установка дверной ручки', '300 – 700 ₽'],
      ['Установка доводчика двери', '1 000 – 2 000 ₽'],
      ['Регулировка двери', '500 – 1 200 ₽'],
      ['Установка наличников (комплект)', '800 – 1 500 ₽'],
      ['Установка порога', '500 – 1 000 ₽'],
      ['Замена петель (пара)', '500 – 1 000 ₽'],
      ['Установка глазка', '300 – 600 ₽'],
      ['Ремонт дверной коробки', '1 500 – 3 000 ₽'],
    ]
  },
  repair: {
    icon: '🏠',
    ...
    prices: [
      ['Сборка/разборка мебели (шкаф)', '2 000 – 4 000 ₽'],
      ['Сборка кровати', '1 500 – 3 000 ₽'],
      ['Сборка комода / тумбы', '800 – 1 500 ₽'],
      ['Сборка стеллажа', '1 000 – 2 000 ₽'],
      ['Ремонт мебельных петель', '300 – 600 ₽'],
      ['Подрезка двери', '800 – 1 500 ₽'],
      ['Укладка плинтуса (за метр)', '150 – 350 ₽'],
